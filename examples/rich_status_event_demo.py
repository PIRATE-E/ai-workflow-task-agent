...
from event_decorators import make_class_event_aware, EventAwareBase, event_aware_property
...
class DataAnalyzer:
    ...
    def analyze_data(self, data_size=100):
        ...
        self.status = "completed"  # 🎯 Automatically updates Rich.status!
        emit_status_event(self.__class__, f"✅ Analysis completed! Found {self.results_count} results")
