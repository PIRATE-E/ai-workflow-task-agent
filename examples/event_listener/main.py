...
from event_helpers import emit_status_event, emit_variable_event, emit_error_event, progress_update
...
class FileProcessor(SimpleEventAwareClass):
    ...
    def process_files(self, file_list):
        ...
        for i, filename in enumerate(file_list):
            ...
            # Update progress
            self.progress = int((i + 1) / len(file_list) * 100)  # 🎯 Automatically updates Rich.status!
...
class DatabaseManager(SimpleEventAwareClass):
    ...
    def connect(self):
        ...
        emit_variable_event(self.__class__, "connection_count", old_count, self.connection_count)
