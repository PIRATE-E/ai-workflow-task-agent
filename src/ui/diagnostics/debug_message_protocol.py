...
class DebugMessageSender:
    ...
    def send_performance_warning(self,
                                operation: str,
                                duration: float,
                                threshold: float,
                                context: str,
...
def send_debug_message(socket_connection, heading: str, body: str, level: str = "INFO", metadata: Dict[str, Any] = None):
